    ...
    async execute (interaction) {
        ...
        switch (sub) {
            ...
            const rule = await guild.autoModerationRules.create({
                name: `Block profinity, sexual content, and slurs by TBYW`,
                creatorId: '935651547721895986',
                enabled: true,
                eventType: 1,
                triggerType: 4,
                triggerMetadata: 
                ...
                actions: [
                    {
                        ...
                        metadata: {
                            ...
                            durationSeconds: 10,
                            customMessage: 'This message was prevented by TBYW'
                        }
                    }
                ]
            }).catch(async err => {
            ...
            const rule2 = await guild.autoModerationRules.create({
                name: `Prevent the word ${word} by TBYW`,
                creatorId: '935651547721895986',
                enabled: true,
                eventType: 1,
                triggerType: 1,
            ...
            const rule3 = await guild.autoModerationRules.create({
                name: `Prevent Spam Messages by TBYW`,
                creatorId: '935651547721895986',
                enabled: true,
                eventType: 1,
                triggerType: 5,
